...
# serviceKey=kv5KjSGpridc7Ai%2BQIqvr%2B8jzmgkmfQeM5XqJO8xL1Gvknk7KLsDU4lwEaZpY0taxMMY5QKaZGq3QUopmUOYVg%3D%3D
# &pageNo=1
# &numOfRows=10
# &dataType=JSON
...
collection = database['rent-loan-rate-info_rate-list']                          # insert 작업 진행
